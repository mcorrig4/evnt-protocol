...
/**
 * v0 by Vercel.
 * @see https://v0.dev/t/Wuk0qKGLbvF
 * Documentation: https://v0.dev/docs#integrating-generated-code-into-your-nextjs-app
 */
function Component() {
  return (
    <footer className="bg-gray-900 text-white py-6 px-4 sm:px-6 md:px-8">
        ...
        <div className="flex items-center space-x-4">
          <div className="h-8 w-8 bg-gray-800 rounded-full flex items-center justify-center">
            <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 20 20">
              ...
              <path d="M10 6a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H8a1 1 0 110-2h3V7a1 1 0 011-1z" />
            </svg>
          </div>
          <span className="text-lg font-bold">CryptoApp</span>
        </div>
      ...
      <div className="container mx-auto mt-4 text-center text-sm text-gray-400">
